...
describe('MockDate', function() {
  ...
  it('should override Date.prototype.getTimezoneOffset', function() {
    MockDate.set(new Date(mockDate), { timezoneOffset: -1 });
    should.equal(-1, new Date().getTimezoneOffset());
  });

  it('should override Date.prototype.getHours', function() {
    MockDate.set(new Date(mockDate), { hours: 10 });
    should.equal(10, new Date().getHours());
  });

  it('should override Date.prototype.getMinutes', function() {
    MockDate.set(new Date(mockDate), { minutes: 30 });
    should.equal(30, new Date().getMinutes());
  });
